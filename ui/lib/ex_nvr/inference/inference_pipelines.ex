defmodule ExNVR.Inference.InferencePipelines do
  @moduledoc """
  ...
  @pipelines (if Code.ensure_loaded?(Hailo) do
                [
                  {ExNVR.Inference.YoloObjectDetector, :yolo_object_detector},
                  {ExNVR.Inference.HailoObjectDetector, :hailo_object_detector}
                ]
              else
                [
                  {ExNVR.Inference.YoloObjectDetector, :yolo_object_detector}
  ...
  """
  @spec config_fields_for(atom()) :: [ExNVR.Inference.InferencePipeline.config_field()]
