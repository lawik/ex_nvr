defmodule ExNVR.Inference.YoloObjectDetector do
  @moduledoc """
  ...
  @impl true
  @spec handle_buffer(:input, Membrane.Buffer.t(), map(), map()) ::
  ...
  defp rescale_detections(detections, ratio, w_pad, h_pad) do
