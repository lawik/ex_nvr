defmodule ExNVRWeb.InferencePipelineLive do
      ...
      <div class="px-6 lg:px-8 bg-gray-300 dark:bg-gray-800">
        ...
        >
          ...
          <.input
            ...
            id="pipeline_type"
            type="select"
            options={ExNVR.AI.InferencePipelines.type_options()}
            label="Type"
  ...
  def mount(%{"id" => "new"}, _session, socket) do
    ...
    {:ok,
     assign(socket,
       ...
       config_fields: ExNVR.AI.InferencePipelines.config_fields_for(default_type),
       config_values: %{}
     )}
  end
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    {:ok,
     assign(socket,
       ...
       config_fields: ExNVR.AI.InferencePipelines.config_fields_for(pipeline.type),
  ...
  def handle_event("validate", %{"pipeline" => params}, socket) do
    ...
    config_fields = ExNVR.AI.InferencePipelines.config_fields_for(type_atom)
  ...
  defp config_bool_value(config_values, field) do
    ...
    case Map.get(config_values, key) do
      ...
      val -> ExNVR.AI.InferencePipeline.parse_bool(val, field.default == true)
    end
  end
end
